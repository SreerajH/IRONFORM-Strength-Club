...
const DotField = memo(({
  ...
  // useId keeps the gradient id stable across server and client renders (Math.random breaks hydration)
  ...
  useEffect(() => {
    ...
    // reduced-motion: render the grid once, no cursor interaction, no rAF loop
    function drawStatic() {
